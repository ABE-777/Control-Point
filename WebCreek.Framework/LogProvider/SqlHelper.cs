...
namespace WebCreek.Framework.LogProvider
{ 
    public class SqlHelper
    {
        ...
        {
            string command = $@"INSERT INTO [dbo].[ErrorLog] ([EventID],[LogLevel],[Message],[CreatedTime]) VALUES (@EventID, @LogLevel, @Message, @CreatedTime)";
